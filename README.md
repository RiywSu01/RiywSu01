...
#### 🥗 [Calories-app (CalPal)](https://github.com/RiywSu01/Calories-app)

A full-stack nutrition-tracking web app with AI-powered food logging. Integrates the **FatSecret API** for food search and **Gemini Vision** for image-based meal analysis, with authentication, RBAC, webhook verification, rate limiting, and caching built in.

**Highlights:**
- 🔐 Auth & RBAC via Clerk, with verified webhooks
- 🚦 Multi-tier rate limiting + 24-hour response caching
- 📷 Image-based meal analysis via Gemini Vision
- 🐳 Optimized containerized deployment with Docker
...
#### 🏨 [BackEnd-Project-Y3](https://github.com/RiywSu01/BackEnd-Project-Y3)

A hotel booking REST API system with event-driven notifications and production-style deployment. Built to practice backend architecture end-to-end — auth, caching, testing, and reverse-proxy deployment.

**Highlights:**
- 🔑 JWT authentication with RBAC
- 📩 Event-driven notification system
- 🧪 Automated testing suite
- 🌐 Deployed behind Nginx with Docker
...
#### 🛏️ [Project_MYKEA](https://github.com/RiywSu01/Project_MYKEA)

An e-commerce web app for bedroom furniture and accessories, with catalog search/filtering and full RESTful CRUD product management.
